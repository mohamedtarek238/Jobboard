                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="<?php echo APPURL;?>/users/update-profile.php?upd_id=<?php echo $_SESSION['id'];?>">Update profile</a>
                     ...
                     <?php if(isset($_SESSION['type']) AND $_SESSION['type'] == 'worker'): ?>
                          ...
                          <a class="dropdown-item" href="<?php echo APPURL;?>/users/saved-jobs.php?id=<?php echo $_SESSION['id'];?>">Saved Jobs</a>
                    <?php endif; ?>
                    <?php if(isset($_SESSION['type']) AND $_SESSION['type'] == 'company'): ?>

                        <a class="dropdown-item" href="<?php echo APPURL;?>/users/show-applicants.php?id=<?php echo $_SESSION['id'];?>">Show Applications</a>
                    <?php endif; ?>
