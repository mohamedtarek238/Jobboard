...
//getting jobs with the same category
...
// number of related jobs 
  $job_count = $conn->prepare("SELECT COUNT(*) as job_count FROM jobs WHERE job_category = :job_category AND status = 1 AND id != :id");
  $job_count->bindParam(':job_category', $row->job_category, PDO::PARAM_STR);
  $job_count->bindParam(':id', $id, PDO::PARAM_INT);
  $job_count->execute();
...
if(isset($_SESSION['id'])){
  ...
  // checking for the job if it saved or not
 ...
 //cheking if the user apply for the job before
          ...
          <div class="col-lg-8 mb-4 mb-lg-0">
            <div class="d-flex align-items-center">
              <div class="border p-2 d-inline-block mr-3 rounded">
                <img style="width: 100px; height: 100px;"  src="../users/user-images/<?php echo $row->company_image ?>" alt="Image">
              </div>
              <div>
          ...
          <div class="col-lg-8">
            ...
            <?php if(isset($_SESSION['username'])): ?>
              <?php  if(isset($_SESSION['type']) AND $_SESSION['type'] == 'worker'): ?>
                ...
                <?php else: ?>
                  <div class="col-6">
                  <a href="job-save.php?job_id=<?php echo $id;?>&worker_id=<?php echo $_SESSION['id']?>&status=unsave"  class="btn btn-block btn-light btn-md"><i class="icon-heart text-danger"></i>Un Save Job</a>
            ...
            <form  action="job-single.php?id=<?php echo $id ?>" method="post">
                ...
                <!-- Hidden Inputs for Job Details -->
                <input type="hidden" name="username" value="<?php echo $_SESSION['username'] ?>">
                <input type="hidden" name="email" value="<?php echo $_SESSION['email'] ?>">
                <input type="hidden" name="cv" value="<?php echo $_SESSION['cv'] ?>">
                <input type="hidden" name="worker_id" value="<?php echo $_SESSION['id'] ?>">
                ...
                <input type="hidden" name="company_id" value="<?php echo $row->company_id ?>">
                  ...
                  <div class="text-center">
                    <button name="submit_application" type="submit" class="btn btn-primary btn-md px-4">
                      <i class="icon-paper-plane"></i> Apply Now
                    </button>
                  </div>
            </form>
            <?php else: ?>
              <div class="col-6">
                              <h3  class="btn btn-block btn-primary btn-md">you applied for this job</h3>
              </div>
            <?php endif;?>
            </div>
                  <?php endif; ?>
            ...
            <div class="col-6">
              ...
              <div class="col-6">
                <a style="margin-left: 250px;" href="<?php echo APPURL?>/jobs/job-delete.php?id=<?php echo $row->id  ?>" class="btn btn-block btn-danger btn-md">Delete</a>
              </div>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><strong class="text-black">Category:</strong><?php echo ucfirst($row->job_category)  ?></li>
                </ul>
            </div>
    ...
    <section class="site-section" id="next">
      <div class="container">
        ...
        <ul class="job-listings mb-5">
          <?php foreach($related_job as $Rjob): ?>
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $Rjob->id ?>"></a>
            <div class="job-listing-logo">
              <img src="../users/user-images/<?php echo $Rjob->company_image ?>" alt="Image" class="img-fluid">
            </div>

            <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
              <div class="job-listing-position custom-width w-50 mb-3 mb-sm-0">
                <h2><?php echo $Rjob->job_title; ?></h2>
                <strong><?php echo $Rjob->company_name; ?></strong>
              </div>
              <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
                <span class="icon-room"></span> <?php echo $Rjob->job_region; ?>
              </div>
              <div class="job-listing-meta">
              <span class="badge badge-<?php if($Rjob->job_type == 'Full Time'){echo 'success';}else{ echo 'danger';}?>"><?php echo $Rjob->job_type ?></span>
              </div>
            </div>
