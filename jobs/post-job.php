          ...
          <div class="col-lg-12">
            <form class="p-4 p-md-5 border rounded" action="post-job.php" method="post">
              ...
              <div class="form-group">
                ...
                <select name="job_category" class="selectpicker border rounded" id="job-category" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Category">
              ...
              <div class="form-group">
              <input type="hidden" value="<?php echo isset($_SESSION['email']) ? $_SESSION['email'] : ''; ?>" name="company_email" class="form-control" id="" placeholder="Company Email">
              ...
              <div class="form-group">
              <input type="hidden" name="company_image" value="<?php echo isset($_SESSION['image']) ? $_SESSION['image'] : ''; ?>" class="form-control" id="">
