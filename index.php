...
<?php
 ...
 $searches->execute();
 $ALLsearch = $searches->fetchAll(PDO::FETCH_OBJ);
?>
        ...
        <ul class="job-listings mb-5">
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            ...
            <div class="job-listing-logo">
              <img src="<?php echo APPURL ?>/users/user-images/<?php echo $job->company_image ?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </div>
            ...
            <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
              ...
              <span class="badge badge-<?php if($job->job_type == 'Full Time'){echo 'success';}else{ echo 'danger';}?>"><?php echo $job->job_type ?></span>
              </div>
            </div>
